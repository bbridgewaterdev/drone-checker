...
var NATS_LAYER_TYPES=[{key:'frz',color:'#ef4444',label:'Airport (FRZ)'},{key:'egr',color:'#f59e0b',label:'Restricted Area (EGR)'},{key:'prohibited',color:'#7c3aed',label:'Prohibited Area'},{key:'danger',color:'#f97316',label:'Danger Area'}];
