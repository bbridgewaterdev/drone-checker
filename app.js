...
function renderWeatherCard(){
  ...
  return (
    '<div class="card" id="weather-card"><div class="card-ttl">Current Weather</div><div class="wx-hero"><span class="wx-icon">'+info.emoji+'</span><div><div class="wx-temp">'+tPrimary+' <span style="font-size:22px;font-weight:600;color:var(--muted);">/ '+tSecondary+'</span></div><div class="wx-desc">'+wxDesc+' &middot; feels '+fPrimary+' / '+fSecondary+'</div></div></div>'+
    '<div class="wx-grid">'+
